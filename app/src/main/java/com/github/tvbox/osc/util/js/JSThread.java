...
public class JSThread {
    ...
    public void postVoid(JSEngine.Event<Void> event) throws Throwable {
        postVoid(event, true);
    }

    public void postVoid(JSEngine.Event<Void> event, boolean block) throws Throwable {
        if ((thread != null && thread.isInterrupted())) {
            LOG.e("QuickJS", "QuickJS is released");
            return;
        }
    ...
    @Keep
    @JSMethod(alias = "pdfl")
    public Object parseDomForList(@JSParameter("html") String html, @JSParameter("p1") String p1, @JSParameter("list_text") String list_text, @JSParameter("list_url") String list_url, @JSParameter("urlKey") String urlKey) {
        try {
