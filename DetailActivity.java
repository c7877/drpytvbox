...
public class DetailActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        mPlayerFrame.setVisibility(showPreview ? View.VISIBLE : View.GONE);
        ...
        seriesAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (vodInfo != null && vodInfo.seriesMap.get(vodInfo.playFlag).size() > 0) {
                    ...
                    if (vodInfo.playIndex % GroupCount != position) {
    ...
    private void insertPlayerFragment() {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .add(DETAIL_PLAYER_FRAME_ID, playFragment, PlayFragment.FRAGMENT_TAG)
    ...
    private List<VodSeriesGroup> getSeriesGroupList() {
        ...
        try {
            ...
            GroupIndex = (int) Math.ceil(vodInfo.playIndex / (GroupCount + 0.0)) - 1;
            if (GroupIndex < 0) {
                GroupIndex = 0;
            }
            if (size > GroupCount) {
    ...
    public static PlayFragment getManagedPlayerFragment() {
        if(DetailActivity.playFragment == null)
            DetailActivity.playFragment = new PlayFragment();
        return DetailActivity.playFragment;
    }
    ...
    void toggleFullPreview() {
        ...
        mPlayerFrame.setVisibility(fullWindows ? View.GONE : View.VISIBLE);
